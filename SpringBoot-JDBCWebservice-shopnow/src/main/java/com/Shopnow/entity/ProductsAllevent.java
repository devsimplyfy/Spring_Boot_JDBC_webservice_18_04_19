...
public class ProductsAllevent {
	...
	public ProductsAllevent(int id,String name,String description,String Category_name,String parent_category,float regular_price,float sale_price,String stock,String image,String[] image_extra)
	 {
		this.id=id;
		this.name=name;
